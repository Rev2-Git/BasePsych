...
class ClientPrefs {
	...
	public static var baseGameUI:String = 'Friday Night Funkin';
	public static var ratingCams:String = 'World';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.baseGameUI = baseGameUI;
		FlxG.save.data.ratingCams = ratingCams;
